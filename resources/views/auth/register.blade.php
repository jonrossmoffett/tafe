...
<div class="mx-auto h-full flex justify-center items-center bg-gray-300">
    <div class="bg-blue-900 w-96 rounded-lg shadow-xl p-6">
        ...
        <h2 class="text-blue-300 ">Enter your credentials bellow</h1>
            ...
            <form class="pt-8" method="POST" action="{{ route('register') }}">
                ...
                <div class="relative">
                    ...
                    <div class="">
                        <input id="name" type="text" class="pt-8 w-full rounded p-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700" name="name" value="" autocomplete="email" autofocus placeholder="your name">
                ...
                <div class="pt-3">
                    ...
                    <div class="">
                        <input id="password" type="password" class="pt-8 w-full rounded p-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700" name="password" autocomplete="current-password">
                ...
                <div class="pt-3">
                    <label for="password_confirmation" class="uppercase text-blue-500 text-xs font-bold absolute pl-3 pt-2">re enter your password</label>

                    <div class="">
                        <input id="password_confirmation" type="password" class="pt-8 w-full rounded p-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700" name="password_confirmation" autocomplete="current-password">
                ...
                <div class="pt-8">
                    <button type="submit" class="uppercase rounded text-gray-100 font-bold w-full bg-gray-400 text-blue-800 py-2 px-3 text-left">
                        register
                    </button>
                </div>
