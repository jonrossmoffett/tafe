  ...
  <div>
    ...
    <div class="relative z-10">
      ...
      >
        ...
        <div v-for="result in results" :key="result.links.self" @click="focus = false">
          <router-link :to="result.links.self" class="py-2 block" @click="focus = false">
            <div class="flex items-center">
              <UserProfile :name="result.data.name"></UserProfile>
              <div class="pl-3">
